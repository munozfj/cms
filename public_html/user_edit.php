  ...
  <div class="row row-offcanvas row-offcanvas-right">
    ...
    <div class="col-xs-12 col-sm-9">
      ...
      <div class="jumbotron">
        ...
        <!--Start Contact form -->                                                    
        <form action="user_update.php" method="post" class="form-horizontal" role="form" >
          <fieldset> 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="username" id="username" value="<?php echo $current_user['username']; ?>"  size="45" >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="first_name" id="first_name" value="<?php echo $current_user['first_name']; ?>"  size="45" >
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="last_name" id="last_name" value="<?php echo utf8_encode($current_user['last_name']); ?>"  size="45" >
              </div>
            </div>
            ...
            <button name="submit" class="btn btn-primary">Update User</button>
